    ...
    <div className="space-y-6">
      ...
      {currentEvaluation ? (
        <div className="space-y-6">
          ...
          {/* Current hash of the evaluated document */}
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-slate-500 text-[10px] uppercase font-bold block mb-1">Document Hash</span>
            <span className="font-bold text-slate-800" break-all font-mono text-xs>
              {currentEvaluation.file_hash || currentEvaluation?.file_hash || "Not Available"}
            </span>
          </div>

          {/* Previous hash of the evaluated document */}
          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
            <span className="text-slate-500 text-[10px] uppercase font-bold block mb-1">Previous Document Hash</span>
            <span className="font-bold text-slate-800" break-all font-mono text-xs>
              {currentEvaluation?.previous_file_hash || currentEvaluation?.previous_file_hash || "Not Available"}
            </span>
          </div>
