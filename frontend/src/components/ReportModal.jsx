        ...
        <div className="p-8 sm:p-12 text-slate-800" id="printable-certificate">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-8">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] text-slate-500">SHA256 Hashes</span>
            </div>
            <div className="text-[11px] text-slate-800 font-mono bg-slate-100 p-3 rounded-lg border border-slate-200">
              <div><span className="font-bold">Current File Hash:</span> {evaluation?.file_hash || evaluation?.file_hash || 'N/A'}</div>
              <div><span className="font-bold">Previous File Hash:</span> {evaluation?.previous_file_hash || evaluation?.previous_file_hash || 'N/A'}</div>
            </div>
